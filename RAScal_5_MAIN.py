...
def show_refer():
    ...
    ref_text = Label(refer, text="Пример перевода числа 10 в коды.\n"
                                 ...
                                 "1. Чтобы перевести число в прямой код сначала нужно перевести модуль числа в "
                                 "двоичную систему, а затем добавить слева знаковый бит: 1 если число меньше 0 и 0 "
                                 "если число больше 0.\n"
                                 "2. Так как 10>0, то знаковый бит равен 0.\n"
                                 "3. Двоичное представление числа 10 равно 0001010.\n"
                                 "4. Добавляя слева знаковый бит, получаем прямой код числа 10 равным 00001010; "
                                 "Переводя код в 16-ричную систему, включая знаковый бит, получаем 0a.\n"
                                 "II. ПЕРЕВОД В ОБРАТНЫЙ КОД\n"
                                 "1. Обратный код для положительного числа совпадает с прямым, а для отрицательного "
                                 "числа все цифры заменяются на противоположные (1 на 0, 0 на 1), в знаковый бит "
                                 "записывается 1.\n"
                                 "2. Так как 10>0, то обратный код соответствует прямому\n"
                                 "3. Добавляя слева знаковый бит, получаем обратный код числа 10 равным 00001010; "
                                 "Переводя код в 16-ричную систему, включая знаковый бит, получаем 0a.\n"
                                 "III. ПЕРЕВОД В ДОПОЛНИТЕЛЬНЫЙ КОД\n"
                                 "1. Дополнительный код для положительного числа совпадает с прямым, "
                                 "а для отрицательного числа к младшему разряду обратного кода добавляется 1.\n"
                                 "2. Так как 10>0, то дополнительный код соответствует прямому и равен 00001010; "
                                 "Переводя код в 16-ричную систему, включая знаковый бит, получаем 0a.)\n")
    ref_text.pack()
